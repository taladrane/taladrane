- 👋 Hi, I’m Madison, also known as @taladrane. I manage the [Advisory Database](https://github.com/advisories) team here at GitHub 👋 and I used to work in incident response at GitHub and performed vulnerability coordination at the [CERT/CC](https://kb.cert.org/). I also participate in the [Open Source Security Foundation](https://openssf.org/), serve as the co-chair to the Vulnerability Disclosure Working Group, and am a [CVE Board member](https://www.cve.org/Media/News/item/blog/2024/01/09/Madison-Oliver-GitHub-Security-Lab-CVE-Board).
- 👀 I’m interested in ...
